...
from cli_anything.65_guide.core.session import Session
...
@handle_error
def repl():
    from cli_anything.65_guide.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("65-guide",version="1.0.0");skin.print_banner()
