...
from cli_anything.076_dash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.076_dash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("076-dash",version="1.0.0");skin.print_banner()
