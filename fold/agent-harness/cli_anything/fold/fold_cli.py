...
from cli_anything.fold.core.session import Session
...
@handle_error
def repl():
    from cli_anything.fold.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("fold",version="1.0.0");skin.print_banner()
