...
@handle_error
def run_cmd(args):
    """Run arbitrary imagemagick command."""
    import subprocess
    result=subprocess.run(["imagemagick"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("imagemagick",version="1.0.0");skin.print_banner()
