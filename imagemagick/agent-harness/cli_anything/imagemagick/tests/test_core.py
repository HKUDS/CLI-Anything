"""Tests for ImageMagick core module."""
...
class TestConvertModule:
    def test_import(self):
        from cli_anything.imagemagick.core import convert

        assert hasattr(convert, "convert")
        assert hasattr(convert, "info")
        assert hasattr(convert, "resize")
        assert hasattr(convert, "crop_image")
        assert hasattr(convert, "thumbnail")
        assert hasattr(convert, "watermark")
        assert hasattr(convert, "border")
        assert hasattr(convert, "montage")
        assert hasattr(convert, "animate_info")
        assert hasattr(convert, "compare")
        assert hasattr(convert, "batch")
