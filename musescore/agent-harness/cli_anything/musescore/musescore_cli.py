...
@handle_error
def run_cmd(args):
    """Run arbitrary musescore command."""
    import subprocess
    result=subprocess.run(["musescore"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("musescore",version="1.0.0");skin.print_banner()
