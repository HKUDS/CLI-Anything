...
from cli_anything.actinium_cache.core.session import Session
...
@handle_error
def repl():
    from cli_anything.actinium_cache.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("actinium-cache",version="1.0.0");skin.print_banner()
