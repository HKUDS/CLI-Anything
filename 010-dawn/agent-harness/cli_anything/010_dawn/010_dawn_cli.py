...
from cli_anything.010_dawn.core.session import Session
...
@handle_error
def repl():
    from cli_anything.010_dawn.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("010-dawn",version="1.0.0");skin.print_banner()
