...
from cli_anything.homeassistant.core.session import Session
...
@handle_error
def run_cmd(args):
    """Run arbitrary hass command."""
    import subprocess
    result=subprocess.run(["hass"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("homeassistant",version="1.0.0");skin.print_banner()
