...
from cli_anything.027_guard.core.session import Session
...
@handle_error
def repl():
    from cli_anything.027_guard.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("027-guard",version="1.0.0");skin.print_banner()
