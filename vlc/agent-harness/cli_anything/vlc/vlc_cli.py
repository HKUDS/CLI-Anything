...
@handle_error
def run_cmd(args):
    """Run arbitrary vlc command."""
    import subprocess
    result=subprocess.run(["vlc"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("vlc",version="1.0.0");skin.print_banner()
