...
from cli_anything.072_burst.core.session import Session
...
@handle_error
def repl():
    from cli_anything.072_burst.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("072-burst",version="1.0.0");skin.print_banner()
