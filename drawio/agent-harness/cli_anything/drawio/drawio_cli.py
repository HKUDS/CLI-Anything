...
@handle_error
def run_cmd(args):
    """Run arbitrary drawio command."""
    import subprocess
    result=subprocess.run(["drawio"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("drawio",version="1.0.0");skin.print_banner()
