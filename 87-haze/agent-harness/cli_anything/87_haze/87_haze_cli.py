...
from cli_anything.87_haze.core.session import Session
...
@handle_error
def repl():
    from cli_anything.87_haze.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("87-haze",version="1.0.0");skin.print_banner()
