...
from cli_anything.32_flash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.32_flash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("32-flash",version="1.0.0");skin.print_banner()
