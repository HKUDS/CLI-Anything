...
from cli_anything.17_jolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.17_jolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("17-jolt",version="1.0.0");skin.print_banner()
