...
from cli_anything.92_crest.core.session import Session
...
@handle_error
def repl():
    from cli_anything.92_crest.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("92-crest",version="1.0.0");skin.print_banner()
