...
from cli_anything.07_grind.core.session import Session
...
@handle_error
def repl():
    from cli_anything.07_grind.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("07-grind",version="1.0.0");skin.print_banner()
