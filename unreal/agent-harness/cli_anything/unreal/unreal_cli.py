...
@handle_error
def run_cmd(args):
    """Run arbitrary UnrealEditor-Cmd command."""
    import subprocess
    result=subprocess.run(["UnrealEditor-Cmd"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("unreal",version="1.0.0");skin.print_banner()
