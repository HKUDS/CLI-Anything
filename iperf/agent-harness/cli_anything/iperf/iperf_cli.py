...
from cli_anything.iperf.core.session import Session
...
@handle_error
def repl():
    from cli_anything.iperf.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("iperf",version="1.0.0");skin.print_banner()
