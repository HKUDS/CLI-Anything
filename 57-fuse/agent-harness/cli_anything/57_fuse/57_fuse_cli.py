...
from cli_anything.57_fuse.core.session import Session
...
@handle_error
def repl():
    from cli_anything.57_fuse.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("57-fuse",version="1.0.0");skin.print_banner()
