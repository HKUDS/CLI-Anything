...
from cli_anything.97_knot.core.session import Session
...
@handle_error
def repl():
    from cli_anything.97_knot.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("97-knot",version="1.0.0");skin.print_banner()
