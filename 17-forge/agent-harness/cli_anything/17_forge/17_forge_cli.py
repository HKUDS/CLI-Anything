...
from cli_anything.17_forge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.17_forge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("17-forge",version="1.0.0");skin.print_banner()
