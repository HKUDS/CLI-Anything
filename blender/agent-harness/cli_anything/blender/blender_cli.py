...
@handle_error
def run_cmd(args):
    """Run arbitrary blender command."""
    import subprocess
    result=subprocess.run(["blender"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("blender",version="1.0.0");skin.print_banner()
