...
from cli_anything.actinium_count.core.session import Session
...
@handle_error
def repl():
    from cli_anything.actinium_count.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("actinium-count",version="1.0.0");skin.print_banner()
