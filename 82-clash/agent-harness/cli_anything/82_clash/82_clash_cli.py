...
from cli_anything.82_clash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.82_clash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("82-clash",version="1.0.0");skin.print_banner()
