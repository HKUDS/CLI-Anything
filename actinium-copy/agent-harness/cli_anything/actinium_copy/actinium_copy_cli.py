...
from cli_anything.actinium_copy.core.session import Session
...
@handle_error
def repl():
    from cli_anything.actinium_copy.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("actinium-copy",version="1.0.0");skin.print_banner()
