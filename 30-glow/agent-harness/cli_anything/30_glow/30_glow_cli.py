...
from cli_anything.30_glow.core.session import Session
...
@handle_error
def repl():
    from cli_anything.30_glow.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("30-glow",version="1.0.0");skin.print_banner()
