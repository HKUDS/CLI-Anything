...
from cli_anything.002_guide.core.session import Session
...
@handle_error
def repl():
    from cli_anything.002_guide.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("002-guide",version="1.0.0");skin.print_banner()
