...
from cli_anything.04_beam.core.session import Session
...
@handle_error
def repl():
    from cli_anything.04_beam.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("04-beam",version="1.0.0");skin.print_banner()
