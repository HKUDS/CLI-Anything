...
@handle_error
def run_cmd(args):
    """Run arbitrary ollama command."""
    import subprocess
    result=subprocess.run(["ollama"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("ollama",version="1.0.0");skin.print_banner()
