...
@handle_error
def run_cmd(args):
    """Run arbitrary qgis command."""
    import subprocess
    result=subprocess.run(["qgis"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("qgis",version="1.0.0");skin.print_banner()
