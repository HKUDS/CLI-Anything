...
from cli_anything.20_drop.core.session import Session
...
@handle_error
def repl():
    from cli_anything.20_drop.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("20-drop",version="1.0.0");skin.print_banner()
