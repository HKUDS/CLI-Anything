...
from cli_anything.94_frame.core.session import Session
...
@handle_error
def repl():
    from cli_anything.94_frame.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("94-frame",version="1.0.0");skin.print_banner()
