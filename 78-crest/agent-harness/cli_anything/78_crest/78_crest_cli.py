...
from cli_anything.78_crest.core.session import Session
...
@handle_error
def repl():
    from cli_anything.78_crest.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("78-crest",version="1.0.0");skin.print_banner()
