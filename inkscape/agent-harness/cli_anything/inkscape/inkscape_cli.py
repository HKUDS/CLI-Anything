...
@handle_error
def run_cmd(args):
    """Run arbitrary inkscape command."""
    import subprocess
    result=subprocess.run(["inkscape"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("inkscape",version="1.0.0");skin.print_banner()
