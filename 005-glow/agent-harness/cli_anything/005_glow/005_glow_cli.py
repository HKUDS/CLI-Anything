...
from cli_anything.005_glow.core.session import Session
...
@handle_error
def repl():
    from cli_anything.005_glow.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("005-glow",version="1.0.0");skin.print_banner()
