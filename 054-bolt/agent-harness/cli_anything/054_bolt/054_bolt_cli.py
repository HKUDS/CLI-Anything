...
from cli_anything.054_bolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.054_bolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("054-bolt",version="1.0.0");skin.print_banner()
