...
from cli_anything.047_jolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.047_jolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("047-jolt",version="1.0.0");skin.print_banner()
