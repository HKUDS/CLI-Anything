...
@handle_error
def run_cmd(args):
    """Run arbitrary gimp command."""
    import subprocess
    result=subprocess.run(["gimp"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("gimp",version="1.0.0");skin.print_banner()
