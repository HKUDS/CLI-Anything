...
from cli_anything.44_haze.core.session import Session
...
@handle_error
def repl():
    from cli_anything.44_haze.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("44-haze",version="1.0.0");skin.print_banner()
