...
from cli_anything.055_core.core.session import Session
...
@handle_error
def repl():
    from cli_anything.055_core.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("055-core",version="1.0.0");skin.print_banner()
