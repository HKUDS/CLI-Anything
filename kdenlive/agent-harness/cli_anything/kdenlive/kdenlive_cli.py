...
@handle_error
def run_cmd(args):
    """Run arbitrary kdenlive command."""
    import subprocess
    result=subprocess.run(["kdenlive"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("kdenlive",version="1.0.0");skin.print_banner()
