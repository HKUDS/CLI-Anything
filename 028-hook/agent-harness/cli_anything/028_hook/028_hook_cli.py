...
from cli_anything.028_hook.core.session import Session
...
@handle_error
def repl():
    from cli_anything.028_hook.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("028-hook",version="1.0.0");skin.print_banner()
