...
from cli_anything.059_flash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.059_flash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("059-flash",version="1.0.0");skin.print_banner()
