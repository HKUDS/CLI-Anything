...
from cli_anything.052_jolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.052_jolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("052-jolt",version="1.0.0");skin.print_banner()
