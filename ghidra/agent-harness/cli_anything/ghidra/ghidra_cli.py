...
@handle_error
def run_cmd(args):
    """Run arbitrary ghidra command."""
    import subprocess
    result=subprocess.run(["ghidra"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("ghidra",version="1.0.0");skin.print_banner()
