...
from cli_anything.aria2.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aria2.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aria2",version="1.0.0");skin.print_banner()
