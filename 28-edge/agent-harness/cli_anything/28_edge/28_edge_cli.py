...
from cli_anything.28_edge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.28_edge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("28-edge",version="1.0.0");skin.print_banner()
