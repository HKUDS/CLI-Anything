...
from cli_anything.011_clash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.011_clash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("011-clash",version="1.0.0");skin.print_banner()
