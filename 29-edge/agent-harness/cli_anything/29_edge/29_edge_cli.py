...
from cli_anything.29_edge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.29_edge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("29-edge",version="1.0.0");skin.print_banner()
