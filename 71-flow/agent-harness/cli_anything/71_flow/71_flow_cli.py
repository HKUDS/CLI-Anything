...
from cli_anything.71_flow.core.session import Session
...
@handle_error
def repl():
    from cli_anything.71_flow.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("71-flow",version="1.0.0");skin.print_banner()
