...
from cli_anything.099_hook.core.session import Session
...
@handle_error
def repl():
    from cli_anything.099_hook.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("099-hook",version="1.0.0");skin.print_banner()
