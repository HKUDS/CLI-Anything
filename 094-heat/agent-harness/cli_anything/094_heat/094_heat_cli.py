...
from cli_anything.094_heat.core.session import Session
...
@handle_error
def repl():
    from cli_anything.094_heat.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("094-heat",version="1.0.0");skin.print_banner()
