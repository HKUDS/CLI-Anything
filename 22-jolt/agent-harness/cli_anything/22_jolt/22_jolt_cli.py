...
from cli_anything.22_jolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.22_jolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("22-jolt",version="1.0.0");skin.print_banner()
