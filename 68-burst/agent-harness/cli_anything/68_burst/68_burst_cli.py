...
from cli_anything.68_burst.core.session import Session
...
@handle_error
def repl():
    from cli_anything.68_burst.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("68-burst",version="1.0.0");skin.print_banner()
