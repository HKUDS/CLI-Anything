...
from cli_anything.actinium_clone.core.session import Session
...
@handle_error
def repl():
    from cli_anything.actinium_clone.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("actinium-clone",version="1.0.0");skin.print_banner()
