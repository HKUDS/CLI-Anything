...
from cli_anything.77_cloud.core.session import Session
...
@handle_error
def repl():
    from cli_anything.77_cloud.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("77-cloud",version="1.0.0");skin.print_banner()
