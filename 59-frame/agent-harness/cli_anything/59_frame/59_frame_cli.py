...
from cli_anything.59_frame.core.session import Session
...
@handle_error
def repl():
    from cli_anything.59_frame.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("59-frame",version="1.0.0");skin.print_banner()
