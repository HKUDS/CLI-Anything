...
from cli_anything.36_burst.core.session import Session
...
@handle_error
def repl():
    from cli_anything.36_burst.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("36-burst",version="1.0.0");skin.print_banner()
