...
@handle_error
def run_cmd(args):
    """Run arbitrary exiftool command."""
    import subprocess
    result=subprocess.run(["exiftool"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("exiftool",version="1.0.0");skin.print_banner()
