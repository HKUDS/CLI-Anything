...
@handle_error
def run_cmd(args):
    """Run arbitrary freecad command."""
    import subprocess
    result=subprocess.run(["freecad"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("freecad",version="1.0.0");skin.print_banner()
