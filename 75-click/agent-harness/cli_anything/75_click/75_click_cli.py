...
from cli_anything.75_click.core.session import Session
...
@handle_error
def repl():
    from cli_anything.75_click.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("75-click",version="1.0.0");skin.print_banner()
