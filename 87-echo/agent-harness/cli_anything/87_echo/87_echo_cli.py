...
from cli_anything.87_echo.core.session import Session
...
@handle_error
def repl():
    from cli_anything.87_echo.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("87-echo",version="1.0.0");skin.print_banner()
