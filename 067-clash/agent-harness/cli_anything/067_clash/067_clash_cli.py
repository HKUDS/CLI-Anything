...
from cli_anything.067_clash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.067_clash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("067-clash",version="1.0.0");skin.print_banner()
