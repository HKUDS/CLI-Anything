...
from cli_anything.006_fuse.core.session import Session
...
@handle_error
def repl():
    from cli_anything.006_fuse.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("006-fuse",version="1.0.0");skin.print_banner()
