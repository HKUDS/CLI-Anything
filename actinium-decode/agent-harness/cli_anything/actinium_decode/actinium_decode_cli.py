...
from cli_anything.actinium_decode.core.session import Session
...
@handle_error
def repl():
    from cli_anything.actinium_decode.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("actinium-decode",version="1.0.0");skin.print_banner()
