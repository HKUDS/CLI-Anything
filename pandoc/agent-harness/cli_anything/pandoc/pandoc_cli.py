...
@handle_error
def run_cmd(args):
    """Run arbitrary pandoc command."""
    import subprocess
    result=subprocess.run(["pandoc"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("pandoc",version="1.0.0");skin.print_banner()
