...
from cli_anything.csplit.core.session import Session
...
@handle_error
def repl():
    from cli_anything.csplit.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("csplit",version="1.0.0");skin.print_banner()
