...
from cli_anything.049_flow.core.session import Session
...
@handle_error
def repl():
    from cli_anything.049_flow.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("049-flow",version="1.0.0");skin.print_banner()
