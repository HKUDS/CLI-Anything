...
from cli_anything.93_bolt.core.session import Session
...
@handle_error
def repl():
    from cli_anything.93_bolt.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("93-bolt",version="1.0.0");skin.print_banner()
