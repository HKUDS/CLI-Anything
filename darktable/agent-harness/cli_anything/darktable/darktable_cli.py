...
@handle_error
def run_cmd(args):
    """Run arbitrary darktable command."""
    import subprocess
    result=subprocess.run(["darktable"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("darktable",version="1.0.0");skin.print_banner()
