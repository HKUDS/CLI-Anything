...
@handle_error
def run_cmd(args):
    """Run arbitrary krita command."""
    import subprocess
    result=subprocess.run(["krita"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("krita",version="1.0.0");skin.print_banner()
