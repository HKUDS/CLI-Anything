...
from cli_anything.012_frame.core.session import Session
...
@handle_error
def repl():
    from cli_anything.012_frame.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("012-frame",version="1.0.0");skin.print_banner()
