...
from cli_anything.34_keel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.34_keel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("34-keel",version="1.0.0");skin.print_banner()
