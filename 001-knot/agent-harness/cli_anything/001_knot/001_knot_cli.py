...
from cli_anything.001_knot.core.session import Session
...
@handle_error
def repl():
    from cli_anything.001_knot.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("001-knot",version="1.0.0");skin.print_banner()
