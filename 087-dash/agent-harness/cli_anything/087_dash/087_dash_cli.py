...
from cli_anything.087_dash.core.session import Session
...
@handle_error
def repl():
    from cli_anything.087_dash.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("087-dash",version="1.0.0");skin.print_banner()
