...
from cli_anything.date.core.session import Session
...
@handle_error
def repl():
    from cli_anything.date.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("date",version="1.0.0");skin.print_banner()
