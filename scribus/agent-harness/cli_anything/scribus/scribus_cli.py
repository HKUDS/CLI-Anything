...
@handle_error
def run_cmd(args):
    """Run arbitrary scribus command."""
    import subprocess
    result=subprocess.run(["scribus"]+list(args),capture_output=True,text=True,timeout=300)
...
def repl():
    ...
    skin=ReplSkin("scribus",version="1.0.0");skin.print_banner()
