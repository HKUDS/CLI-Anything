...
from cli_anything.03_burst.core.session import Session
...
@handle_error
def repl():
    from cli_anything.03_burst.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("03-burst",version="1.0.0");skin.print_banner()
