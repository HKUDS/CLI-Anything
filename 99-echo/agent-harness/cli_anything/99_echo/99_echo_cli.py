...
from cli_anything.99_echo.core.session import Session
...
@handle_error
def repl():
    from cli_anything.99_echo.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("99-echo",version="1.0.0");skin.print_banner()
